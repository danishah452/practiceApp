...
import 'package:practice/bloc/bloc.dart';
...
class _loginState extends State<login> {
  ...
  Widget build(BuildContext context) {
    TextStyle _loginText = TextStyle(
      color: Colors.black,
                    ...
                    child:
                      ...
                      Padding(
                          ...
                          child: Text(
                            ...
                            style: TextStyle(color:Colors.deepOrange,fontWeight: FontWeight.bold, fontSize: 22),
                          ),
                      ),
                      SizedBox(
                          height: 40,
                     ...
                     // SizedBox(height: 20,),
                      MaterialButton(
                          ...
                          child: Text('Anonymous ?', style: TextStyle(color: Colors.deepOrange),),
                      ),
                      ...
                      MaterialButton(
                          ...
                          child: Text("Don't have an Account ? Register",style: TextStyle(color: Colors.deepOrange),),
                      ),
