...
class SensorClass extends StatefulWidget {
  SensorClass({Key key, this.title}) : super(key: key);

  final String title;

  @override
  _SensorClassState createState() => _SensorClassState();
}

class _SensorClassState extends State<SensorClass> {
  // color of the circle
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: Text('Keep the circle in the center for 1 second',style: TextStyle(color: Colors.red,fontSize: 18,fontWeight: FontWeight.bold),),
            ),
            Stack(
              children: [
